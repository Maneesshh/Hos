    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                ...
                <h1 class="mt-4 text-center">Doctors logs</h1>
                <br>
            </div>
            <div class="container-fluid d-flex justify-content-end mb-2 mt-1">
                <button class="btn btn-danger btn-sm" onclick="if(confirm('Are you sure?')){
                                        location.href= 'admin/deleteDoctorLog';
                                    }">Delete All</button>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $row['did']; ?></td>
                                    <td class="text-center"><?php $data = $this->AdminModelObj->getDoctorNameById($row['did']);
                                                            echo $data['dname']; ?></td>
