...
<div id="layoutSidenav_content">
    <main>
        <div class="container">
            <form method="POST" action="admin/getAdminProfile" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control is-valid" placeholder="FirstName MiddleName(optional) LastName" required="" id="fullname" name="fullname" maxlength="30" value="<?php echo $_SESSION['admin']['aname'] ?>" />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control is-valid" name="email" id="email" required="" value="<?php echo $_SESSION['admin']['aemail'] ?>" />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" max="10" class="form-control is-valid" id="phone" name="phone" required="" placeholder="10 digit Contact Number" maxlength="10" pattern="[0-9]+" value="<?php echo $_SESSION['admin']['aphone'] ?>" />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control is-valid" id="add" name="add" placeholder="Enter the Address" required="" maxlength="40" value="<?php echo $_SESSION['admin']['aaddress'] ?>" />
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <img class="img w-25 mb-2 rounded" src="<?php echo $_SESSION['admin']['aimage'] ?>" alt="<?php echo $_SESSION['admin']['aname'] ?>">
...
<script>
    ...
    email.addEventListener("blur", (e) => {
        let emailRegex = /^[a-z0-9](\.?\_?[a-z0-9]){5,}@admin.com$/i;
    ...
    setInterval(function() {
        if (nameTest && emailTest && phoneTest && addressTest) {
