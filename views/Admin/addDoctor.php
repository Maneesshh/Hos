...
<div id="layoutSidenav_content">
    <main>
        <div class="container">
            <form method="POST" action="admin/doctorRegistration" enctype="multipart/form-data">
                <div class="modal-body border-none">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    <label for="full name">Doctor Name<span class="text-danger">*</span></label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email" placeholder="xyz@doctor.com" required="" />
                                    <div class="invalid-feedback">Please enter a valid email ending with " @doctor.com
                                        ".
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="speciality" id="speciality" required="" placeholder="Enter Doctor Speciality." />
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="add" name="add" placeholder="Enter the Address" required="" maxlength="40" />
                                    <div class="invalid-feedback">Cannot be empty.</div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    setInterval(function() {
        if (nameTest && nameTest && emailTest && passwordTest && confirmPasswordTest && phoneTest &&
            specialityTest && descriptionTest &&
            addressTest) {
