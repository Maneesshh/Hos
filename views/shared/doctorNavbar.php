        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right mt-2" aria-labelledby="userDropdown">
                <div class="container-fluid">
                    <div class="col w-100">
                        <div class="row">
                            <img class="img-fluid rounded" src="<?php echo $this->doctor['dimage']; ?>" />
                        </div>

                        <div class="text-center font-weight-bold mt-1">
                        <span class="font-weight-lighter"><?php echo $this->doctor['dname']; ?></span><a href="doctor/profile" class="text-decoration-none text-black-50">
