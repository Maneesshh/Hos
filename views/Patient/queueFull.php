...
<div class="container-fluid mt-3 d-flex justify-content-center">
    <div class="row text-center justify-content-center">
        <div class="col-sm-12 col-sm-offset-3">
            ...
            <br>
            <h3>Dear, User</h3>
            <p style="font-size:20px;color:#5C5C5C;">The doctor you are trying to book an appointment with is full.</p>
            <p style="font-size:18px;color:#5C5C5C;">Please try after some time.</p>
